...
//		return count;
//	}
//	double const getinterestrate(double intrate);
//	double const getbalance(double cbal);
//	double const getinterest(double intearn);
//	int const gettransactions(int trans1);
//};
//int bank::count = 0;
...
//	}
//}
//double const bank:: getinterestrate(double intrate3)
//{
//	cout << "\nenter interest rate :   ";
//	cin >> intrate3;
//	intrate = intrate3;
//	return intrate;
//}
//double const bank::getbalance(double cbal1)
//{
//	return cbal;
//}
//double const bank::getinterest(double intearn1)
//{
//	return intearn;
//}
//int const bank::gettransactions(int trans1)
//{
//	inccount();
//	trans += trans1;
//	return trans;
